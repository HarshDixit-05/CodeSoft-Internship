Code_Internship Task

Tasks of intership at Codsoft TASK 1- NUMBER GAME
...
Display appropriate messages to the user based on their chosen options and the success or failure of their transactions. TASK 4- QUIZ APPLICATION WITH TIMER
